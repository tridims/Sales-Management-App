...
create table kategori (
    nama_kategori varchar(30) primary key,
    deskripsi text
)
...
create table produk (
    ...
    kategori varchar(30) foreign key references kategori(nama_kategori) on delete set null
)
...
create table jabatan(
    nama_jabatan varchar(30) primary key,
    gaji int not null,
)
...
create table customer_profile (
    ...
    desa_kecamatan varchar(20) not null,
